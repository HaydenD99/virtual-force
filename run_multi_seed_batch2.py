...
if __name__ == "__main__":
    print("\n" + "="*90)
    print(" 多随机种子四算法对比实验 - 批次2 ".center(90))
    print("="*90)
    ...
    for idx, seed in enumerate(SEEDS, 1):
        ...
        try:
            ...
            # 保存中间结果
            save_results(all_results, f'batch2_partial_{idx}.json')
    ...
    if all_results:
        ...
        # 保存最终结果
        save_results(all_results, 'batch2_final.json')
