...
import time
import os
from compare_optimizers_fair import run_fair_comparison
...
if __name__ == "__main__":
    print("\n" + "="*90)
    print(f" 四算法对比 - 原始Fitness - {NUM_UAV} UAVs - 种子{SEED} ".center(90))
    print("="*90)
    
    print(f"\n📊 实验配置:")
    print(f"   • 随机种子: {SEED}")
    print(f"   • UAV数量: {NUM_UAV}")
    print(f"   • Fitness: 原始版本（仅min_rate优化）")
