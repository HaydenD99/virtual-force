...
# 6 UAVs数据 (种子76)
with open('result/original_6uav_seed76.json', 'r') as f:
    data['6UAV'] = json.load(f)

# 9 UAVs数据 (种子76，从seeds_66_76_partial_11.json)
with open('result/seeds_66_76_partial_11.json', 'r') as f:
    all_seeds = json.load(f)
    data['9UAV'] = all_seeds['seed_76']

# 12 UAVs数据 (种子76)
with open('result/original_12uav_seed76.json', 'r') as f:
...
# ============================================================================
# Figure 1: Minimum Rate Comparison (Seed 76)
# ============================================================================
...
ax1.set_title('(a) Minimum User Rate Comparison - Seed 76', fontweight='bold')
...
ax2.set_title('(b) Minimum Rate Improvement - Seed 76', fontweight='bold')
...
plt.tight_layout()
plt.savefig('result/seed76_minimum_rate_comparison.png', dpi=300, bbox_inches='tight')
print("✓ Saved: result/seed76_minimum_rate_comparison.png")
plt.close()

# ============================================================================
# Figure 2: Sum Rate Comparison (Seed 76)
# ============================================================================
...
ax1.set_title('(a) System Sum Rate Comparison - Seed 76', fontweight='bold')
ax1.set_xticks(x + width * 1.5)
ax1.set_xticklabels([f'4AP + {cfg}' for cfg in configs])
ax1.legend(loc='upper left', fontsize=8)
ax1.grid(axis='y', alpha=0.3, linestyle='--')
...
ax2.set_title('(b) Sum Rate Improvement - Seed 76', fontweight='bold')
ax2.set_xticks(x + width * 1.5)
ax2.set_xticklabels([f'4AP + {cfg}' for cfg in configs])
ax2.legend(loc='upper left', fontsize=8)
ax2.grid(axis='y', alpha=0.3, linestyle='--')
...
plt.tight_layout()
plt.savefig('result/seed76_sum_rate_comparison.png', dpi=300, bbox_inches='tight')
print("✓ Saved: result/seed76_sum_rate_comparison.png")
plt.close()

# ============================================================================
# Figure 3: Combined Performance Metrics (Seed 76)
# ============================================================================
...
ax1.set_ylabel('Minimum User Rate (Mbps)', fontweight='bold')
ax1.set_title('(a) Minimum Rate vs UAV Number - Seed 76', fontweight='bold')
...
ax2.set_title('(b) Sum Rate vs UAV Number - Seed 76', fontweight='bold')
...
ax3.set_title('(c) Minimum Rate Absolute Gain - Seed 76', fontweight='bold')
...
ax4.set_title('(d) Sum Rate Absolute Gain - Seed 76', fontweight='bold')
...
plt.suptitle('Performance Comparison - Seed 76 (Original Fitness: min_rate)',
            fontsize=14, fontweight='bold', y=0.995)
plt.savefig('result/seed76_comprehensive_performance_comparison.png', dpi=300, bbox_inches='tight')
print("✓ Saved: result/seed76_comprehensive_performance_comparison.png")
plt.close()
...
# ============================================================================
print("\n" + "="*80)
print("All seed 76 comparison plots generated successfully!")
print("="*80)
print("\nGenerated files:")
print("  1. seed76_minimum_rate_comparison.png")
print("  2. seed76_sum_rate_comparison.png")
print("  3. seed76_comprehensive_performance_comparison.png")
print("\nLocation: result/")
print("="*80)

# Print data summary
print("\n" + "="*80)
print(" Seed 76 Performance Summary ".center(80))
print("="*80)
