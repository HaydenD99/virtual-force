"""
多随机种子四算法对比 - 种子55-65
使用随机种子: 55, 56, 57, 58, 59, 60, 61, 62, 63, 64, 65
寻找更好更合理的结果
"""
...
# 配置
SEEDS = list(range(55, 66))  # [55, 56, 57, 58, 59, 60, 61, 62, 63, 64, 65]
...
def print_aggregated_results(all_results):
    ...
    print("\n" + "="*90)
    print(" 多随机种子聚合结果 (种子55-65) ".center(90))
    print("="*90)
...
if __name__ == "__main__":
    print("\n" + "="*90)
    print(" 多随机种子四算法对比实验 - 种子55-65 ".center(90))
    print("="*90)
    ...
    for idx, seed in enumerate(SEEDS, 1):
        ...
        try:
            ...
            # 保存中间结果
            save_results(all_results, f'seeds_55_65_partial_{idx}.json')
    ...
    if all_results:
        ...
        # 保存最终结果
        save_results(all_results, 'seeds_55_65_final.json')
