...
import time
import os
from compare_optimizers_weighted import run_fair_comparison
...
if __name__ == "__main__":
    ...
    try:
        ...
        optimizers_info = [
            ...
            ('GA', 'GA', WeightedGeneticAlgorithmOptimizer),
            ('PSO', 'PSO', WeightedPSOOptimizer),
            ('NewSSA', 'NewSSA', WeightedNewSSAOptimizer)
        ]
